...
for thisDepth = 1:length(depthNames)
    ...
    clear EEG;
    EEG(1) = pop_loadset(['PreProcessing Intermediates/' save_stems{1} '_unepoched_' depthNames{thisDepth} '_noSpikes.set']);
    EEG(2) = pop_loadset(['PreProcessing Intermediates/' save_stems{2} '_unepoched_' depthNames{thisDepth} '_noSpikes.set']);
