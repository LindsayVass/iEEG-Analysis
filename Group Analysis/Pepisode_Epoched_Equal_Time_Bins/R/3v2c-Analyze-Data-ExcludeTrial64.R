# Script Name:  3v2c-Analyze-Data.R
# Author:       Lindsay Vass
# Date:         24 November 2015
# Purpose:      This script will analyze the data frame produced by 
#               "2b-Clean-Data-ExcludeTrial64.R". For each electrode and frequency band, it will 
#               use a Wilcoxon signed-rank test to determine whether pepisode 
#               significantly differs between timepoints. Data for the Post
#               period of trial 64 are excluded.
...
load('Rda/allCleanData_ExcludeTrial64.Rda')
...
save(file = 'Rda/allAnalyzedData_ExcludeTrial64.Rda', list = c('cleanData', 'electrodePCorr', 'moltenTrueData', 'permData', 'permNSigElectrodes', 'trueData', 'trueNSigElectrodes'))