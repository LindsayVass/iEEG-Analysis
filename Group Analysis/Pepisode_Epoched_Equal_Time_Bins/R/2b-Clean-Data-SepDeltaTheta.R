# Script Name:  2b-Clean-Data-SepDeltaTheta.R
# Author:       Lindsay Vass
# Date:         17 August 2015
# Purpose:      This script will clean the data frame produced by "1-Load-Data.R".
#               It differs from 2-Clean-Data in that Delta and Theta frequencies
#               are kept separate.
...
save(file = 'Rda/allCleanData_SepDeltaTheta.Rda', list = 'cleanData')