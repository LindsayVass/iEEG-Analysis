...
#               files from ../Pepisode_Epoched_Equal_Time_Bins/, which is data
#               from the teleportation epoch. These files contain the pepisode
#               values for each time bin.
#               
#               It will also load the csv files in csv/, which contain the onset
#               offset, and durations of each oscillatory event
...
allTeleporterPepisodeData <- loadAllSubjectData('/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Epoched_Equal_Time_Bins',
                                                sessionInfoNoElec,
                                                'epoched_pepisode_equal_time_bins.csv')
allNavigationSustainData <- loadAllSubjectData('/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Sustainedness/',
                                                 sessionInfoNoElec,
                                                 'navigation_pepisode_sustainedness.csv')
allTeleporterSustainData <- loadAllSubjectData('/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Sustainedness/',
                                               sessionInfoNoElec,
                                               'teleporter_pepisode_sustainedness.csv')
...
save(file = 'Rda/allRawData.Rda', list = c('realNavigationTrialNumbers', 'realTeleporterTrialNumbers', 'allNavigationPepisodeData', 'allTeleporterPepisodeData', 'allNavigationSustainData', 'allTeleporterSustainData', 'sessionInfo'))
