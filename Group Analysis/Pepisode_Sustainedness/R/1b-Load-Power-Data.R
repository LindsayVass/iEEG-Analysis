# Script Name:  1b-Load-Power-Data.R
# Author:       Lindsay Vass
...
#               from the teleportation epoch. These files contain the power
#               values for each time bin. (1-Load-Data.R loads the pepisode 
#               values).
#               
...
allNavigationPowerData <- loadAllSubjectData(getwd(), 
                                                sessionInfoNoElec,
                                                'epoched_navigation_power_equal_time_bins.csv')
allTeleporterPowerData <- loadAllSubjectData('/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Epoched_Equal_Time_Bins',
                                                sessionInfoNoElec,
                                                'epoched_power_equal_time_bins.csv')
...
save(file = 'Rda/allRawPowerData.Rda', list = c('realNavigationTrialNumbers', 'realTeleporterTrialNumbers', 'allNavigationPowerData', 'allTeleporterPowerData', 'sessionInfo'))
