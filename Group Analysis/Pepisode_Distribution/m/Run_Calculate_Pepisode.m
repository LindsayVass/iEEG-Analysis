% This script will run the function "Calculate_Pepisode" for each
...
analysisDir = '/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Distribution/';
...
for thisSubject = 3:size(sessionInfo, 2)
    ...
    for thisSession = 1:size(sessionInfo(thisSubject).teleporter, 2)
        ...
        pepSaveFile = [subjectID '_' teleporter '_pepisode_whole_experiment'];
        powSaveFile = [subjectID '_' teleporter '_power_whole_experiment'];
        
        % Run the analysis
        Calculate_Pepisode(subjectID, ...
            subjectDir, ...
            teleporter, ...
            chanList, ...
