...
timeBinBreaksNt <- c(-1830, 0, 400, 1831, 3661)
timeBinBreaksFt <- c(-2830, 0, 400, 2831, 5661)
timeBinNames  <- c("Pre","Exclude", "Tele", "Post")
...
# Save
save(file = 'Rda/allCleanData_ExcludeFade.Rda', list = 'cleanData')
