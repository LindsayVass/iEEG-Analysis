...
load('Rda/allCleanData_ExcludeFade.Rda')
...
save(file = 'Rda/allClassificationResults_ExcludeFade.Rda', list = c('allClassificationResults', 'allMeanClassificationResults', 'maxElectrodeP', 'sigClassification', 'maxElectrodePermutations', 'allBootstrapClassification'))