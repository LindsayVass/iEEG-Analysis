% Test whether power varies within a frequency band based on timepoint,
% spatial condition, or temporal condition. This analysis will use the
% Kruskal-Wallis test (nonparametric one-way ANOVA) to
% determine whether power significantly varies across conditions in a
...
save_file = '/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Power/Hist_power_by_time_space_timepoint.png';
...
hold off;
title('POWER: Proportion of electrodes modulated by space, time, and timepoint')
