...
addpath('/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Epoched_Equal_Time_Bins/m/');
...
timesNT = [-1429 0; 401 1830; 2231 3660];
timesFT = [-2429 0; 401 2830; 3231 5660];

% frequencies to use
frequencies = logspace(log(1)/log(10),log(181)/log(10),31); % 31 log-spaced frequencies, as in Watrous 2011

% where to save the output
analysisDir = '/Users/Lindsay/Documents/MATLAB/iEEG/Group Analysis/Pepisode_Sustainedness_ExcludeFade/';
...
for thisSubject = 1:size(sessionInfo, 2)
    ...
    for thisSession = 1:size(sessionInfo(thisSubject).teleporter, 2)
        ...
        pepSaveFile = [subjectID '_' teleporter '_epoched_navigation_pepisode_equal_time_bins'];
        powSaveFile = [subjectID '_' teleporter '_epoched_navigation_power_equal_time_bins'];
