...
rawData <- readMat('mat/ParieRawDataPepisodeTrials_1-8Hz.mat')
bestData <- parieData
...
for (thisElec in 1:nlevels(bestData$ElectrodeID)) {
  ...
  for (thisTrialPair in 1:minLength) {
    ...
    fileName <- paste0('Figures/Single Electrode/Parietal/', electrode, '_', thisTrialPair, '.pdf')
