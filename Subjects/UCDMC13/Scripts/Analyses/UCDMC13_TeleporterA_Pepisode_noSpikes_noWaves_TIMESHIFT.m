...
%
% This is a CONTROL analysis, in which I've taken the time points of each
% of my epochs and shifted them ahead 10 seconds. This is achieved by
% passing + 10,000 to the offsetMS parameter of getPepisodeLKV.
%
% Lindsay Vass 21 May 2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
